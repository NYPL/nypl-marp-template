...
Use [Marp](https://marp.app/) to create NYPL themed slide decks from markdown files ([Sample PDF output](https://github.com/NYPL/nypl-marp-template/blob/d949bda33fcdb3d358aac7e112e6927999f82c21/sample.pdf)).
