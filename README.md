...
Use [Marp](https://marp.app/) to create NYPL themed slide decks from markdown files ([Sample PDF output](https://raw.githubusercontent.com/NYPL/nypl-marp-template/refs/heads/main/sample.pdf)),
